    ...
    describe('Search Params Unit Tests', () => {
        test('page prop', () => {
            ...
            arrange.forEach((item) => {
                const params = new repository_contracts_1.SearchParams({ page: item.page });
        ...
        test('per_page prop', () => {
            ...
            arrange.forEach((item) => {
                const params = new repository_contracts_1.SearchParams({ per_page: item.per_page });
        ...
        test('sort prop', () => {
            ...
            arrange.forEach((item) => {
                const params = new repository_contracts_1.SearchParams({ sort: item.sort });
        ...
        test('sort_dir prop', () => {
            ...
            arrange.forEach((item) => {
                const params = new repository_contracts_1.SearchParams({ sort: 'field', sort_dir: item.sort_dir });
        ...
        test('filter prop', () => {
            ...
            arrange.forEach((item) => {
                const params = new repository_contracts_1.SearchParams({ filter: item.filter });
